...
public class SystemHelper extends Main
{
    ...
    public void doubleClickOnContract(String userName, int role, Contracts contract, JFXButton button) throws SQLException {
        try {
        ...
        return new StringConverter<>() {
            ...
            public Date fromString(String string) {
                try {
                    ...
                    showErrorMessage("Ошибка", "Неверно введена дата! Необходим формат ГГГГ-ММ-ДД");
                }
                return Date.valueOf(string);
            }
        };
