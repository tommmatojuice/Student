...
public class AnalyticsTableController {
    ...
    @FXML
    public void initialize(int numberOfTable, String userName, int role) throws SQLException {
                ...
                cell.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
                    ...
                    public void handle(MouseEvent event) {
                        if (event.getClickCount() > 1) {
                            try {
                                systemHelper.doubleClickOnContract(userName, role, contractManager.getById(cell.getTableView().getItems().get(cell.getIndex()).getContractNumber()));
                            } catch (SQLException throwables) {
                                throwables.printStackTrace();
                            }
                        }
